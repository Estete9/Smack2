...
import com.example.smack2.Utilities.URL_GET_CHANNELS
import com.example.smack2.Utilities.URL_GET_MESSAGES
        ...
        val channelsRequest =
            object :
                JsonArrayRequest(Method.GET, URL_GET_CHANNELS, null, Response.Listener { response ->
                    ...
                    Log.d("ERROR", "could not retrieve channels. Error $error")
                    complete(false)
        ...
        val messagesRequest =
            object :
                JsonArrayRequest(Method.GET, url, null, Response.Listener { response ->
                    ...
                    Log.d("ERROR", "could not retrieve messages. Error $error")
                }) {
                override fun getBodyContentType(): String {
                    return "application/json; charset=utf-8"
                }
